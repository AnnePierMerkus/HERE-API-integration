...
import 'package:here_api/core/utils/TimeUtils.dart';
import 'package:here_api/custom_options.dart';
...
class RoutingHERE {
  ...
  RoutingHERE(ShowDialogFunction showDialogCallback,
  ...
  Future<void> addRoute() async {
    var startGeoCoordinates = GeoCoordinates(52.960221, 5.924452); // Kattebos 5, Heerenveen
    var destinationGeoCoordinates = GeoCoordinates(53.246855, 6.535634); // Zernikeplein 7, Groningen
  ...
  void _calculateRoute(List<Waypoint> waypoints){
    ...
    carOptions.routeOptions.speedCapInMetersPerSecond = 14;
